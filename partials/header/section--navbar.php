    ...
    <nav class="navbar">
        <div class="navbar__brand">
            <a class="navbar__logo" href="index.php">
                <img style="height: 100px" width="800px" src="assets/img/Full-White2.png" alt="logo">
            </a>
        ...
        <div class="navbar__menu-holder">
            <div style="margin: auto; padding: 20px 20px" id="js-navbar" class="navbar__menu">
                <ul id="menu-header-menu" class="navbar__start">
                    <li class="eng-text">
                        <a class="navbar-item <?= ($activePage == 'index') ? 'navbar-active' : ''; ?>"
                    ...
                    <li class="eng-text">
                        <a class="navbar-item <?= ($activePage == 'services') ? 'navbar-active' : ''; ?>"
                    ...
                    <li class="dropdown sub-menu eng-text">
                        <a class="navbar-item <?= ($activePage == 'products') ? 'navbar-active' : ''; ?>"
                    ...
                    <li class="dropdown sub-menu french-text">
                        <a class="navbar-item <?= ($activePage == 'products') ? 'navbar-active' : ''; ?>"
                            href="javascript:void(0)">Produits</a>
                        <div class="sub-menu__holder">
                            <ul>
                                <li><a href="products.php" class="navbar-item">SIRETY</a></li>
                                <!-- <li><a href="products.php" class="navbar-item">CRM</a></li>
                    ...
                    <!-- <li>
                        <a class="navbar-item <?= ($activePage == 'about-us') ? 'navbar-active' : ''; ?>"
                            href="about-us.php">About Us</a>
                    </li> -->
                    <li class="eng-text">
                        <a class="navbar-item <?= ($activePage == 'contact-us') ? 'navbar-active' : ''; ?>"
                            href="contact-us.php">Contact Us</a>
                    </li>
                    <li class="french-text">
                        <a class="navbar-item <?= ($activePage == 'contact-us') ? 'navbar-active' : ''; ?>"
                            href="contact-us.php">Contactez-nous</a>
                    </li>
                </ul>
            </div>
            <div class="navbar__right">
                <div class="navbar__lng">

                    <dl id="select-custom" class="select-dropdown">
                        <dt><a href="#"><span>English <img class="flag"
                                        src="assets/img/flag/united-kingdom-flag-icon.svg" alt="" /></span></a></dt>
                        <dd>
                            <ul>
                                <li>
                                    <a href="#" class="js-eng">English
                                        <img class="flag" src="assets/img/flag/united-kingdom-flag-icon.svg" alt="" />
                                        <span class="value">BR</span>
                                    </a>
                                </li>
                                <!-- <li>
                                <a href="#" class="js-ger">German
                                    <img class="flag" src="assets/img/flag/germany-flag-icon.svg" alt="" />
                                    <span class="value">FR</span>
                                </a>
                            </li> -->
                                <li>
                                    <a href="#" class="js-fre">French
